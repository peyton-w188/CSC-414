...
public class DroneMovement : MonoBehaviour {
    ...
    void MovementUpDown()
    {
        if((Mathf.Abs(Input.GetAxis("Vertical")) > 0.2f || Mathf.Abs(Input.GetAxis("Horizontal")) > 0.2f))
        {
            ...
            if(!Input.GetKey(KeyCode.R) && !Input.GetKey(KeyCode.F) && !Input.GetKey(KeyCode.Q) && !Input.GetKey(KeyCode.E))
            {
        ...
        else if(!Input.GetKey(KeyCode.R) && !Input.GetKey(KeyCode.F) && (Mathf.Abs(Input.GetAxis("Vertical")) < 0.2f && Mathf.Abs(Input.GetAxis("Horizontal")) < 0.2f))
        {
            upForce = 98.1f;
        }
    }
